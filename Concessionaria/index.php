...
<head>
	...
	<title>Concessionária Auto Drive</title>
	<link rel="stylesheet" type="text/css" href="css/bootstrap.min.css">
</head>
<body>
	<nav class="navbar navbar-expand-lg bg-dark" data-bs-theme="dark">
	  <div class="container-fluid">
	    <a class="navbar-brand" href="#">Concessionaria Auto Drive</a>
			...
			<div class="col">
				<?php
					...
					switch (@$_REQUEST['page']) {
						...
						default:
							print "<h1>Seja Bem Vindo a Concessionaria Auto Drive!</h1>";
							print "<h1>Encontre o carro perfeito para a sua proxima estrada🚗</h1>";
					}
				?>
			</div>
		</div>
